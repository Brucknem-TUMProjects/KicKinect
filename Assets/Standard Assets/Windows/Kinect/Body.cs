...
namespace Windows.Kinect
{
    ...
    // Windows.Kinect.Body
    //
    public sealed partial class Body : IBody,  Helper.INativeWrapper

    {
        ...
        public override RootSystem.Collections.Generic.Dictionary<Windows.Kinect.Activity, Windows.Kinect.DetectionResult> Activities
        {
            get
            {
                if (_pNative == RootSystem.IntPtr.Zero)
        ...
        public override RootSystem.Collections.Generic.Dictionary<Windows.Kinect.Appearance, Windows.Kinect.DetectionResult> Appearance
        {
            get
            {
                if (_pNative == RootSystem.IntPtr.Zero)
        ...
        public override Windows.Kinect.FrameEdges ClippedEdges
        {
            get
            {
                if (_pNative == RootSystem.IntPtr.Zero)
        ...
        public override Windows.Kinect.DetectionResult Engaged
        {
            get
            {
                if (_pNative == RootSystem.IntPtr.Zero)
        ...
        public override RootSystem.Collections.Generic.Dictionary<Windows.Kinect.Expression, Windows.Kinect.DetectionResult> Expressions
        {
            get
            {
                if (_pNative == RootSystem.IntPtr.Zero)
        ...
        public override Windows.Kinect.TrackingConfidence HandLeftConfidence
        {
            get
            {
                if (_pNative == RootSystem.IntPtr.Zero)
        ...
        public override Windows.Kinect.HandState HandLeftState
        {
            get
            {
                if (_pNative == RootSystem.IntPtr.Zero)
        ...
        public override Windows.Kinect.TrackingConfidence HandRightConfidence
        {
            get
            {
                if (_pNative == RootSystem.IntPtr.Zero)
        ...
        public override RootSystem.Collections.Generic.Dictionary<Windows.Kinect.JointType, Windows.Kinect.JointOrientation> JointOrientations
        {
            get
            {
                if (_pNative == RootSystem.IntPtr.Zero)
        ...
        public override RootSystem.Collections.Generic.Dictionary<Windows.Kinect.JointType, Windows.Kinect.Joint> Joints
        {
            get
            {
                if (_pNative == RootSystem.IntPtr.Zero)
        ...
        public override Windows.Kinect.TrackingState LeanTrackingState
        {
            get
            {
                if (_pNative == RootSystem.IntPtr.Zero)
        ...
        public override ulong TrackingId
        {
            get
            {
                if (_pNative == RootSystem.IntPtr.Zero)
    ...
    {
        internal abstract RootSystem.IntPtr GetIntPtr();
        internal abstract void SetIntPtr(RootSystem.IntPtr intPtr);

        public abstract RootSystem.Collections.Generic.Dictionary<Windows.Kinect.Activity, Windows.Kinect.DetectionResult> Activities { get; }
        public abstract RootSystem.Collections.Generic.Dictionary<Windows.Kinect.Appearance, Windows.Kinect.DetectionResult> Appearance { get; }
        public abstract Windows.Kinect.FrameEdges ClippedEdges { get; }
        public abstract Windows.Kinect.DetectionResult Engaged { get; }

        public abstract RootSystem.Collections.Generic.Dictionary<Windows.Kinect.Expression, Windows.Kinect.DetectionResult> Expressions { get; }
        public abstract Windows.Kinect.TrackingConfidence HandLeftConfidence { get; }
        public abstract Windows.Kinect.HandState HandLeftState { get; }

        public abstract Windows.Kinect.TrackingConfidence HandRightConfidence { get; }
        public abstract bool IsRestricted { get; }
        public abstract bool IsTracked { get; }

        public abstract RootSystem.Collections.Generic.Dictionary<Windows.Kinect.JointType, Windows.Kinect.JointOrientation> JointOrientations { get; }
        public abstract RootSystem.Collections.Generic.Dictionary<Windows.Kinect.JointType, Windows.Kinect.Joint> Joints { get; }
        public abstract Windows.Kinect.TrackingState LeanTrackingState { get; }
        public abstract ulong TrackingId { get; }
    }
}
