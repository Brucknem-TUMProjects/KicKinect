...
namespace Windows.Kinect
{
    ...
    //
    public sealed partial class BodyFrameSource : IBodyFrameSource, Helper.INativeWrapper 
    ...
    public abstract class IBodyFrameSource
    {
        public abstract IBodyFrameReader OpenReader();
        public abstract IBodyFrameReader OpenReader(string path);
        public abstract int BodyCount { get; }
    }

    public abstract class IBodyFrameReader
    {
        public abstract IBodyFrame AcquireLatestFrame();
