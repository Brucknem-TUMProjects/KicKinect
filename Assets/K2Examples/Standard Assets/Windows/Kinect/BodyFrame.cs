...
namespace Windows.Kinect
{
    ...
    //
    public sealed partial class BodyFrame : IBodyFrame, RootSystem.IDisposable, Helper.INativeWrapper

    {
        ...
        public override Windows.Kinect.Vector4 FloorClipPlane
        {
            get
            {
                if (_pNative == RootSystem.IntPtr.Zero)
        ...
        public override RootSystem.TimeSpan RelativeTime
        {
            get
            {
                if (_pNative == RootSystem.IntPtr.Zero)
