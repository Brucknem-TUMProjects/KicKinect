...
\column{0.5}{
	\block{\kk}{
		\kki{} is the implementation of the game \textit{Torwandschießen} where the player tries to kick a football through two openings in a goal wall.
		...
		\image{../Screenshots/main/shooting_scene.png}{Figure 1: Welcome screen of KicKinect}{800px}
	}
