...
/// </summary>
public static class KinectJointExtension
{
    /// <summary>
    ...
    public static UnityEngine.Vector4 Unity(this Vector4 quaternion)
    {
        return new UnityEngine.Vector4(quaternion.X, quaternion.Y, quaternion.Z, quaternion.W);
    }
}